  ...
  return (
    <div className="App">
      <BrowserRouter>
        ...
        >
          <AuthProvider>
            {userLoggedIn ? <HeaderLogged /> : <Header />}
            ...
            {loginInfo.currentuser ? <>{loginInfo.currentuser}</> : <></>}

            {serverData_question ? (
              <GenericBox
                questionTitle="EXAMPLE QUESTION"
                userAnswer="EXAMPLE ANSWER"
                rewardModifier="EXAMPLE REWARD"
                userMoney="YOUR MONEY"
              />
            ) : (
              <></>
            )}
